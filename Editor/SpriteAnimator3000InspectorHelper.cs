...
namespace Spritesheet3000.Editor
{
    public static class SpriteAnimator3000InspectorHelper
    {
        ...
        public static void OnInspectorDraw<T>(SerializedObject serializedObject, BaseSpriteAnimator3000<T> anim, ref float currentTime, ref string[] currentClipOptions) where T : Component
        {
            if (anim == null)
                return;
